...
Usaremos el modelo Granite-7B-LAB-Q4, una versión cuantificada del modelo Granite-7B-LAB que es compatible con llama.cpp y afinado usando la metodología LAB. El primer modelo no está entrenado mientras que el segundo sí.

Debemos mover los modelos a sus respectivos directorios:
